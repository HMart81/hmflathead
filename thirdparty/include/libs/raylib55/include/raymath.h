/**********************************************************************************************
*
*   raymath v2.0 - Math functions to work with RLVector2, RLVector3, RLMatrix and Quaternions
*
*   CONVENTIONS:
...
//----------------------------------------------------------------------------------
// Module Functions Definition - RLVector4 math
//----------------------------------------------------------------------------------
...
RMAPI void MatrixDecompose(RLMatrix mat, RLVector3 *translation, RLQuaternion *rotation, RLVector3 *scale)
{
    ...
    RLVector3 s = { scalex, scaley, scalez };
